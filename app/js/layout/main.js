...
TweenMax.staggerFromTo('.header_menu_item', 1, { scale:0, delay:6},{ scale:1, ease:Back.easeIn}, 0.05);
TweenMax.staggerFromTo('.header_submenu_item', 1, { scale:0, delay:6},{ scale:1, ease:Back.easeIn}, 0.05);
